...
$(document).ready(function(){
    ...
    $(".move").on("click", function(e){
        ...
        let nameEle = $("input[name=bno]"); //name속성값이 bno인 요소
        nameEle.remove(); //그놈  dom요소 제거
		//vanilla js는 부모.removeChild(자식)으로 지우고
		//jquery는 자신.remove();로 지운다.
        
         //비어있는 moveForm에 동적으로 hidden input으로 bno를 추가하는 작업
         //이것만 있으면 뒤로가기를 했을 때 bno가 누적되는 현상이 발생한다.
    ...
    //페이지 이동
 	...
 	$(".search_area button").on("click", function(e){
        ...
        moveForm.find("input[name='pageNum']").val(1); //검색된 결과의 첫 페이지
        moveForm.submit();
    });
</script>
